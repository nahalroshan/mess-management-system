...
export default function Stats () {
    ...
    return (
        <div className="flex flex-col w-96 h-40 bg-white mr-10 space-y-6">
            ...
            <div className="flex flex-row justify-between mr-16 ml-4">
                <div className="flex flex-col">
                    <div className="text-white rounded-full flex items-center justify-center text-2xl bg-onion w-14 h-14">52</div>
